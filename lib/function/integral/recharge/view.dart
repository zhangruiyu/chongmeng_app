  ...
  return Scaffold(
    ...
    body: SingleChildScrollView(
      child: Column(
        children: <Widget>[
          //充值选项
          ...state.rechargeList.map((itemRecharge) {
            var index = state.rechargeList.indexOf(itemRecharge);
            bool isSelect = index == state.selectItemPosition;
            return InkWell(
              onTap: () {
                dispatch(RechargeActionCreator.onChangeSelectPosition(index));
              },
              child: Container(
                decoration: BoxDecoration(
                    color: isSelect ? Colors.black.withOpacity(0.5) : null,
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Row(
                      children: <Widget>[
                        Text(itemRecharge.primary.toString()),
