...
cinemaListEntityFromJson(CinemaListEntity data, Map<String, dynamic> json) {
	...
	data.paging = json['paging'] != null ? new CinemaListPaging().fromJson(json['paging']) : null;
...
cinemaListCinemaFromJson(CinemaListCinema data, Map<String, dynamic> json) {
	...
	data.tag = json['tag'] != null ? new CinemaListCinemasTag().fromJson(json['tag']) : null;
	data.promotion = json['promotion'] != null ? new CinemaListCinemasPromotion().fromJson(json['promotion']) : null;
